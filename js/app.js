(() => {
    ...
    function initSlidersHome() {
        if (document.querySelector(".guests__slider")) new core(".guests__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    function initSlidersService() {
        if (document.querySelector(".type-list__slider")) new core(".type-list__slider", {
